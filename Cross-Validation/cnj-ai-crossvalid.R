...
parSapply(cl, 1:10, function(i) { library(lme4); library(polytomous);
  ...
  fpreds <- "PV.Qual + PV.Discourse + PV.Position + PV.WantCan + AI.do + AI.cooking + AI.health + RdplW + NA.persons.actor + Sg.actor + Pl.actor + NDA.Relations.actor + actor.3 + actor.1 + actor.2 +
(1 | Lemma)"
