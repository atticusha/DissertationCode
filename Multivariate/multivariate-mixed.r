...
sink(file = "./kaa-cnj-ii-mixed.txt")
...
sink(file = "./kaa-cnj-ai-mixed.txt")
...
sink(file = "./kaa-cnj-ti-mixed.txt")
...
sink(file = "./kaa-cnj-ta-mixed.txt")
round(print(summary(ta.kaa.cnjtype.glmer)$coefficients, max.print = NA), 3)
sink(NULL)

###==========================================================================================================
###Conjunct Type Alternation: Other Conjunct
###==========================================================================================================
####VII
...
sink(file = "./other-cnj-ii-mixed.txt")
...
sink(file = "./other-cnj-ai-mixed.txt")
...
sink(file = "./other-cnj-ti-mixed.txt")
...
sink(file = "./other-cnj-ta-mixed.txt")
