...
sink(file = "./ai-ecnj-ModelStats.my.morph.txt")
...
sink(file = "./ti-ecnj-ModelStats.my.morph.txt")
...
sink(file = "./ta-ecnj-ModelStats.my.morph.txt")
...
sink(file = "./ai-kaacnj-ModelStats.my.morph.txt")
...
sink(file = "./ti-kaacnj-ModelStats.my.morph.txt")
...
sink(file = "./ta-kaacnj-ModelStats.my.morph.txt")
...
sink(file = "./ai-other-ModelStats.my.morph.txt")
...
sink(file = "./ti-other-ModelStats.my.morph.txt")
...
sink(file = "./ta-other-ModelStats.my.morph.txt")
