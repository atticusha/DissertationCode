...
sink(file = "./Semantic Random/ive-ii.sem.txt")
...
sink(file = "./Semantic Random/ive-ai.sem.txt")
...
sink(file = "./Semantic Random/ive-ti.sem.txt")
...
sink(file = "./Semantic Random/ive-ta.sem.txt")
...
sink( file = "./Semantic Random/ivc-ii.sem.txt")
...
sink(file = "./Semantic Random/ivc-ai.sem.txt")
...
sink(file = "./Semantic Random/ivc-ti.sem.txt")
...
sink(file = "./Semantic Random/ivc-ta.sem.txt")
...
sink(file = "/Semantic Random/e-cnj-ii.sem")
...
sink(file = "/Semantic Random/e-cnj-ai.sem")
...
sink(file = "/Semantic Random/e-cnj-ti.sem")
...
sink(file = "/Semantic Random/e-cnj-ta.sem")
...
sink(file = "/Semantic Random/kaa-cnj-ii.sem")
...
sink(file = "./Semantic Random/kaa-cnj-ai.sem")
...
sink(file = "./Semantic Random/kaa-cnj-ti.sem")
...
sink(file = "./Semantic Random/kaa-cnj-ta.sem")
...
sink(file = "./Semantic Random/other-cnj-ii.sem")
...
sink(file = "./Semantic Random/other-cnj-ai.sem")
...
sink(file = "./Semantic Random/other-cnj-ti.sem")
...
sink(file = "./Semantic Random/other-cnj-ta.sem")
