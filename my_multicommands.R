...
sink(file = '~/Dres/Multi/mixed-ive-ii.txt')
...
sink(file = '~/Dres/Multi/mixed-ive-ai.txt')
...
sink(file = '~/Dres/Multi/mixed-ive-ti.txt')
...
sink(file = '~/Dres/Multi/mixed-ive-ta.txt')
...
sink(file = '~/Dres/Multi/mixed-ivc-ii.txt')
...
sink(file = '~/Dres/Multi/mixed-ivc-ai.txt')
...
sink(file = '~/Dres/Multi/mixed-ivc-ti.txt')
...
sink(file = '~/Dres/Multi/mixed-ivc-ta.txt')
...
sink(file = '~/Dres/Multi/mixed-e-cnj-ii.txt')
...
sink(file = '~/Dres/Multi/mixed-e-cnj-ai.txt')
...
sink(file = '~/Dres/Multi/mixed-e-cnj-ti.txt')
...
sink(file = '~/Dres/Multi/mixed-e-cnj-ta.txt')
...
sink(file = '~/Dres/Multi/mixed-kaa-cnj-ii.txt')
...
sink(file = '~/Dres/Multi/mixed-kaa-cnj-ai.txt')
...
sink(file = '~/Dres/Multi/mixed-kaa-cnj-ti.txt')
...
sink(file = '~/Dres/Multi/mixed-kaa-cnj-ta.txt')
...
sink(file = '~/Dres/Multi/mixed-other-cnj-ii.txt')
...
sink(file = '~/Dres/Multi/mixed-other-cnj-ai.txt')
...
sink(file = '~/Dres/Multi/mixed-other-cnj-ti.txt')
...
sink(file = '~/Dres/Multi/mixed-other-cnj-ta.txt')
